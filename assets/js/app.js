...
!function (f, m, v, b) {
  b.chatbox_show = function () {
    ...
    this.chatbox && (this.chatbox = !1, this.$div.removeClass("aqarchat--chatbox aqarchat--tooltip"), this.settings.message_badge && this.$(".aqarchat__badge").removeClass("aqarchat__badge--out"), f(v).trigger("aqarchat:hide"));
  }, b.optin = function () {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunknewaqarr"] = self["webpackChunknewaqarr"] || [];
