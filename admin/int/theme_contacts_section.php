...
function phone_number_callback() {
    ...
    echo '<input type="text" name="newaqar_theme_settings[phone_number]" value="' . $phone_number . '" />';
}
function whatsapp_number_callback() {
    $options = get_option('newaqar_theme_settings');
    $whatsapp_number = isset($options['whatsapp_number']) ? esc_attr($options['whatsapp_number']) : '';
    echo '<input type="text" name="newaqar_theme_settings[whatsapp_number]" value="' . $whatsapp_number . '" />';
}
function whatsapp_message_callback() {
    $options = get_option('newaqar_theme_settings');
    $whatsapp_message = isset($options['whatsapp_message']) ? esc_attr($options['whatsapp_message']) : '';
    echo '<textarea name="newaqar_theme_settings[whatsapp_message]">' . $whatsapp_message . '</textarea>';
}