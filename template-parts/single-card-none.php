...
<div class="unit-card p-0">
    <div class="recent-property-none" itemscope itemtype="http://schema.org/CreativeWork">
        ...
        <div class="title-container">
            <a  href="<?php the_permalink(); ?>" class="title-none" itemprop="name"><?php the_title(); ?></a>
            <?php
        ...
        <div class="col-12 project-location" >
